          ...
          <div className="grid md:grid-cols-2 gap-20 items-center">
            <div>
              <div className="w-full h-96 rounded-sm overflow-hidden">
                <img 
                  src="https://upload-static.hoyoverse.com/hoyolab-wiki/2023/10/09/6799252/e95d84fac094efa6246a367989478604_5635285495681672897.png?x-oss-process=image%2Fformat%2Cwebp" 
                  alt="Jingliu - Honkai Star Rail" 
                  className="w-full h-full object-cover hover:scale-105 transition-transform duration-500"
                  onError={(e) => {
                    e.target.style.display = 'none';
                    e.target.parentElement.innerHTML = `<div class="w-full h-full bg-gradient-to-br ${gradientClasses} rounded-sm flex items-center justify-center"><span class="text-2xl font-light opacity-50">Jingliu</span></div>`;
                  }}
                />
              </div>
            </div>
